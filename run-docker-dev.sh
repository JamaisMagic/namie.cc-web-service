...
if [ "$1" == "build" ]; then
    ...
    docker-compose -f ./docker-compose.yml -f ./docker-compose.dev.override.yml up -d --scale namie_cc_web_service=2 namie_cc_web_service
elif [ "$1" == "recreate" ]; then
    docker-compose -f ./docker-compose.yml -f ./docker-compose.dev.override.yml up -d --scale namie_cc_web_service=2 --build --force-recreate namie_cc_web_service
elif [ "$1" == "restart" ]; then
    ...
    docker-compose -f ./docker-compose.yml -f ./docker-compose.dev.override.yml rm namie_cc_web_service
elif [ "$1" == "logs" ]; then
